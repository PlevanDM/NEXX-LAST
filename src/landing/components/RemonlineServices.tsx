...
const RemonlineServices: React.FC = () => {
  ...
  if (loading) {
    return (
      <section id="remonline-services" className="py-12 sm:py-16 md:py-24 px-3 sm:px-4 bg-black overflow-x-hidden">
    ...
    <section id="remonline-services" className="py-12 sm:py-16 md:py-24 px-3 sm:px-4 bg-black overflow-x-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-10 sm:mb-16">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-3 sm:mb-4">{t('remonlineServices.title')}</h2>
          <p className="text-gray-400 text-sm sm:text-lg">{t('remonlineServices.subtitle')}</p>
        </div>
