      ...
      h('div', { className: 'flex items-center justify-between h-16' },
        h('a', { href: '/', className: 'flex items-center gap-3' },
          ...
          h('div', {},
            ...
            h('div', { className: 'text-xs text-slate-600' }, 'Калькулятор вартості')
          )
        ),
        h('a', { href: '/', className: 'text-sm font-medium text-slate-700 hover:text-blue-600 transition-colors' },
