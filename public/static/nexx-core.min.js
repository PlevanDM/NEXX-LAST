...
(function() {
  ...
  class NEXXCore {
    ...
    async init() {
      ...
      // Предзагружаем чанки базы (публичные: config, devices, prices, services)
      await this.preload([
        '/data/chunks/config.json',
        '/data/chunks/devices.json',
        '/data/chunks/prices.json',
        '/data/chunks/services.json'
      ]);
