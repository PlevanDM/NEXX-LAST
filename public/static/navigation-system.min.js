...
(function() {
  ...
  const SITE_MAP = {
    home: {
      ...
      children: ['services', 'calculator', 'about', 'faq']
    },
    services: {
      id: 'services',
      path: '/#services',
  ...
  const QuickActions = ({ currentPage }) => {
    ...
    const actions = [
      ...
      { id: 'cabinet', labelKey: 'quickActions.home', icon: 'fa-user', gradient: 'from-gray-700 to-gray-600', path: '/cabinet' },
      { id: 'phone', labelKey: 'quickActions.call', icon: 'fa-phone', gradient: 'from-gray-800 to-gray-900', path: 'tel:+40758117409' },
