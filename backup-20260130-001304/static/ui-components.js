        ...
        h('div', { className: 'flex items-center justify-between' },
          ...
          h('a', { 
            ...
            h('img', {
              ...
              onError: function(e) {
                e.target.style.opacity = '1';
                console.warn('Logo failed to load, showing anyway');
              }
            })
          ),
          ...
          h('div', { className: 'flex md:hidden items-center gap-2' },
            ...
            h('button', {
              ...
              className: `w-12 h-12 flex items-center justify-center rounded-lg ${isScrolled ? 'bg-gray-200 hover:bg-gray-300' : 'bg-transparent hover:bg-white/10 border border-white/20'} ${textColor} transition-all duration-300`,
