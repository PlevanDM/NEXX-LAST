...
(function() {
  ...
  const translations = {
    ...
    ro: {
      ...
      forms: {
        ...
        callback: {
          title: 'Solicitare Apel Invers',
          subtitle: 'Vom suna în curând',
          device: 'Tip de dispozitiv',
          problem: 'Descrieți problema',
          preferredTime: 'Ora preferată pentru apel',
          aiCallEnabled: 'Permiteți asistentului AI să sune',
          submit: 'Solicitare Apel',
          submitting: 'Se trimite...',
          success: 'Apel solicitat! Vom suna în curând.',
          aiWillCall: 'Asistentul AI va suna în 10 secunde'
        },
        diagnostic: {
          title: 'Cerere de Diagnosticare',
          subtitle: 'Obțineți diagnosticarea profesională a dispozitivului',
          device: 'Dispozitiv',
          brand: 'Marcă',
          model: 'Model',
          findings: 'Rezultate diagnostice',
          status: 'Status',
          estimatedRepairCost: 'Cost estimat de reparație',
          estimatedRepairTime: 'Timp estimat de reparație',
          submit: 'Trimiteți Diagnosticul',
          success: 'Diagnosticul trimis!'
        },
        document: {
          title: 'Cerere de Document',
          subtitle: 'Solicitați documente oficiale de reparație',
          type: 'Tip de document',
          orderId: 'ID Comandă',
          address: 'Adresa de livrare',
          includeDetails: 'Includeți detalii complete',
          submit: 'Solicitare Document',
          success: 'Cerere de document trimisă!'
        }
      },
      ...
      documents: {
        types: {
          ...
          contract: 'Contract de Servicii',
          estimate: 'Ofertă de preț',
          receipt: 'Chitanță',
          warranty: 'Card Garanție'
        },
        fields: {
        ...
        sections: {
          ...
          items: 'Produse și servicii',
          summary: 'Rezumat',
          signature: 'Semnătura autorizată'
        },
        actions: {
          generate: 'Generare document',
          download: 'Descărcare',
          preview: 'Previzualizare',
          print: 'Tipărire',
          email: 'Trimitere prin Email'
        }
      },
      ...
      validation: {
        ...
        invalidPhone: 'Numărul de telefon nevalid',
        ...
        documentNotFound: 'Document nu a fost găsit'
      }
    }
  };
  ...
  const LanguageSwitcher = ({ isScrolled = false, compact = false }) => {
    ...
    const bgColor = isScrolled ? 'bg-gray-200 hover:bg-gray-300 text-gray-800' : 'bg-transparent hover:bg-white/10 text-white';
